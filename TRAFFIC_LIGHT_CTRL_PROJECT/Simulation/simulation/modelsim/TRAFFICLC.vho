...
-- Equation(s):
-- \TIME1|Equal0~8\ = (\TIME1|count\(2) & (\TIME1|count\(3) & (C1_count[5] & \TIME1|count\(4))))
...
-- Equation(s):
-- \TIME1|count\(7) = DFFEAS((((!\TIME1|Equal0~10\ & \TIME1|Add0~135_combout\))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME1|count\(9) = DFFEAS((((\TIME1|Add0~125_combout\))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME1|Equal0~6\ = (\TIME1|count\(13) & (!\TIME1|count\(10) & (!C1_count[11] & \TIME1|count\(12))))
...
-- Equation(s):
-- \TIME1|count\(12) = DFFEAS(((\TIME1|Add0~105_combout\ & (!\TIME1|Equal0~10\))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME1|Equal0~5\ = (\TIME1|count\(15) & (\TIME1|count\(14) & (!C1_count[16] & \TIME1|count\(17))))
...
-- Equation(s):
-- \TIME1|Equal0~4\ = (\TIME1|count\(21) & (\TIME1|count\(20) & (!C1_count[18] & \TIME1|count\(19))))
...
-- Equation(s):
-- \TIME1|Equal0~9_combout\ = (\TIME1|Equal0~7\ & (\TIME1|Equal0~6\ & (\TIME1|Equal0~8\ & \TIME1|Equal0~5\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \TIME1|Equal0~7\,
	datab => \TIME1|Equal0~6\,
	datac => \TIME1|Equal0~8\,
	datad => \TIME1|Equal0~5\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\TIME1|S1\ : maxv_lcell
-- Equation(s):
-- \TIME1|Equal0~10\ = (\TIME1|Equal0~2\ & (\TIME1|Equal0~3\ & (\TIME1|Equal0~4\ & \TIME1|Equal0~9_combout\)))
...
PORT MAP (
	clk => \Clk~combout\,
	dataa => \TIME1|Equal0~2\,
	datab => \TIME1|Equal0~3\,
	datac => \TIME1|Equal0~4\,
...
-- Equation(s):
-- \TIME1|count\(25) = DFFEAS(((\TIME1|Add0~40_combout\ & (!\TIME1|Equal0~10\))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME1|Equal0~1\ = (!\TIME1|count\(26) & (!\TIME1|count\(28) & (!C1_count[29] & !\TIME1|count\(27))))
...
-- Equation(s):
-- \TIME1|Equal0~2\ = (!\TIME1|count\(30) & (\TIME1|Equal0~1\ & (!C1_count[31] & \TIME1|Equal0~0\)))
...
-- Equation(s):
-- \TIME2|Add0~152_cout0\ = CARRY((\TIME1|count\(0) & (\TIME1|count\(1))))
-- \TIME2|Add0~152COUT1_156\ = CARRY((\TIME1|count\(0) & (\TIME1|count\(1))))
...
-- Equation(s):
-- \TIME2|Equal0~7\ = (\TIME2|count\(3) & (\TIME2|count\(4) & (D1_count[5] & \TIME2|count\(2))))
...
-- Equation(s):
-- \TIME2|Equal0~6\ = (!\TIME2|count\(7) & (\TIME2|count\(9) & (D1_count[6] & !\TIME2|count\(8))))
...
-- Equation(s):
-- \TIME2|Equal0~5\ = (\TIME2|count\(13) & (!\TIME2|count\(10) & (!D1_count[11] & \TIME2|count\(12))))
...
-- Equation(s):
-- \TIME2|count\(12) = DFFEAS((\TIME2|Add0~95_combout\ & (((!\TIME2|Equal0~9\)))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME2|Equal0~3\ = (!\TIME2|count\(19) & (\TIME2|count\(18) & (!D1_count[20] & \TIME2|count\(21))))
...
-- Equation(s):
-- \TIME2|Equal0~8_combout\ = (\TIME2|Equal0~6\ & (\TIME2|Equal0~4\ & (\TIME2|Equal0~5\ & \TIME2|Equal0~7\)))
...
PORT MAP (
	...
	datac => \TIME2|Equal0~5\,
	datad => \TIME2|Equal0~7\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \TIME2|Equal0~2\ = (\TIME2|count\(22) & (\TIME2|count\(25) & (!D1_count[24] & \TIME2|count\(23))))
...
-- Equation(s):
-- \TIME2|count\(28) = DFFEAS(GND, GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , \TIME2|Add0~15_combout\, , , VCC)
...
-- Equation(s):
-- \TIME2|Equal0~0\ = (\TIME2|count\(26) & (\TIME2|count\(27) & (!D1_count[29] & !\TIME2|count\(28))))
...
\TIME2|S1\ : maxv_lcell
-- Equation(s):
-- \TIME2|Equal0~9\ = (\TIME2|Equal0~2\ & (\TIME2|Equal0~3\ & (\TIME2|Equal0~8_combout\ & \TIME2|Equal0~1\)))
...
PORT MAP (
	clk => \Clk~combout\,
	dataa => \TIME2|Equal0~2\,
	datab => \TIME2|Equal0~3\,
...
-- Equation(s):
-- \Y_Present.S6~regout\ = DFFEAS((\TIME2|S1~regout\ & (\TIME1|S1~regout\ & ((\Y_Present.S5~regout\)))) # (!\TIME2|S1~regout\ & ((\Y_Present.S6~regout\) # ((\TIME1|S1~regout\ & \Y_Present.S5~regout\)))), GLOBAL(\Clk~combout\), VCC, , , , , \Reset~combout\, )
...
-- Equation(s):
-- \Y_Present.S7~regout\ = DFFEAS((\Y_Present.S6~regout\ & ((\TIME2|S1~regout\) # ((!\TIME1|S1~regout\ & \Y_Present.S7~regout\)))) # (!\Y_Present.S6~regout\ & (!\TIME1|S1~regout\ & ((\Y_Present.S7~regout\)))), GLOBAL(\Clk~combout\), VCC, , , , , 
-- \Reset~combout\, )
...
-- Equation(s):
-- \Y_Present.S0~regout\ = DFFEAS(((\Selector0~0_combout\) # ((!\TIME2|S1~regout\ & \Y_Present.S0~regout\))) # (!\Y_Present.rst~regout\), GLOBAL(\Clk~combout\), VCC, , , , , \Reset~combout\, )
...
-- Equation(s):
-- \Y_Present.S1~regout\ = DFFEAS((\Y_Present.S1~regout\ & (((\TIME2|S1~regout\ & \Y_Present.S0~regout\)) # (!\TIME1|S1~regout\))) # (!\Y_Present.S1~regout\ & (\TIME2|S1~regout\ & ((\Y_Present.S0~regout\)))), GLOBAL(\Clk~combout\), VCC, , , , , 
-- \Reset~combout\, )
...
-- Equation(s):
-- \Y_Present.S4~regout\ = DFFEAS((\TIME1|S1~regout\ & ((\Y_Present.S3~regout\) # ((!\TIME2|S1~regout\ & \Y_Present.S4~regout\)))) # (!\TIME1|S1~regout\ & (((!\TIME2|S1~regout\ & \Y_Present.S4~regout\)))), GLOBAL(\Clk~combout\), VCC, , , , , \Reset~combout\, 
-- )
