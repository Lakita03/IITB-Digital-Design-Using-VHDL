...
SIGNAL \dut_instance|add_instance|inst2|inst9|Y~0\ : std_logic;
SIGNAL \dut_instance|add_instance|inst4|inst9|Y~0\ : std_logic;
SIGNAL \dut_instance|add_instance|inst6|inst4|Y~0\ : std_logic;
SIGNAL \dut_instance|add_instance|inst6|inst9|Y~0\ : std_logic;
...
SIGNAL \dut_instance|add_instance|inst8|inst4|Y~0\ : std_logic;
SIGNAL \datau[0]~1_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|inst4|inst4|Y~0\ : std_logic;
...
SIGNAL \dut_instance|add_instance|inst8|inst9|Y~0\ : std_logic;
...
-- Equation(s):
-- \dut_instance|add_instance|inst2|inst9|Y~0\ = ((dut_input(1) & ((dut_input[5]))) # (!dut_input(1) & (dut_input(0))))
-- dut_input(5) = DFFEAS(\dut_instance|add_instance|inst2|inst9|Y~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst2|inst9|Y~0\,
	regout => dut_input(5));

-- Location: LC_X8_Y6_N3
\dut_input[6]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|inst4|inst9|Y~0\ = (\dut_instance|add_instance|inst2|inst9|Y~0\ & ((dut_input[6]) # (dut_input(2) $ (dut_input(0))))) # (!\dut_instance|add_instance|inst2|inst9|Y~0\ & (dut_input[6] & (dut_input(2) $ (dut_input(0)))))
-- dut_input(6) = DFFEAS(\dut_instance|add_instance|inst4|inst9|Y~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|inst2|inst9|Y~0\,
	datab => dut_input(2),
	datac => data(6),
	datad => dut_input(0),
	aclr => GND,
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst4|inst9|Y~0\,
	regout => dut_input(6));

-- Location: LC_X8_Y6_N1
\dut_input[0]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|inst4|inst4|Y~0\ = (dut_input(2) $ (dut_input[0] $ (dut_input(6))))
-- dut_input(0) = DFFEAS(\dut_instance|add_instance|inst4|inst4|Y~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst4|inst4|Y~0\,
	regout => dut_input(0));

-- Location: LC_X7_Y8_N1
\dut_input[3]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|inst6|inst4|Y~0\ = (dut_input(7) $ (dut_input[3] $ (dut_input(0))))
-- dut_input(3) = DFFEAS(\dut_instance|add_instance|inst6|inst4|Y~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst6|inst4|Y~0\,
	regout => dut_input(3));

-- Location: LC_X7_Y8_N7
\dut_input[7]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|inst6|inst9|Y~0\ = (\dut_instance|add_instance|inst4|inst9|Y~0\ & ((dut_input[7]) # (dut_input(3) $ (dut_input(0))))) # (!\dut_instance|add_instance|inst4|inst9|Y~0\ & (dut_input[7] & (dut_input(3) $ (dut_input(0)))))
-- dut_input(7) = DFFEAS(\dut_instance|add_instance|inst6|inst9|Y~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|inst4|inst9|Y~0\,
	datab => dut_input(3),
	datac => data(7),
	datad => dut_input(0),
	aclr => GND,
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst6|inst9|Y~0\,
	regout => dut_input(7));
...
\datau[4]\ : maxv_lcell
-- Equation(s):
-- datau(4) = DFFEAS((\shift_reg~2_combout\ & (((\dut_instance|add_instance|inst8|inst9|Y~0\)))) # (!\shift_reg~2_combout\ & (datau(4) & ((!\shift_reg~3_combout\)))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => datau(4),
	datab => \dut_instance|add_instance|inst8|inst9|Y~0\,
...
-- Equation(s):
-- \dut_instance|add_instance|inst8|inst4|Y~0\ = dut_input(8) $ (((dut_input[4] $ (dut_input(0)))))
-- dut_input(4) = DFFEAS(\dut_instance|add_instance|inst8|inst4|Y~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst8|inst4|Y~0\,
	regout => dut_input(4));

-- Location: LC_X7_Y8_N5
\dut_input[8]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|inst8|inst9|Y~0\ = (\dut_instance|add_instance|inst6|inst9|Y~0\ & ((dut_input[8]) # (dut_input(4) $ (dut_input(0))))) # (!\dut_instance|add_instance|inst6|inst9|Y~0\ & (dut_input[8] & (dut_input(4) $ (dut_input(0)))))
-- dut_input(8) = DFFEAS(\dut_instance|add_instance|inst8|inst9|Y~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|inst6|inst9|Y~0\,
	datab => dut_input(4),
	datac => data(8),
	datad => dut_input(0),
	aclr => GND,
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst8|inst9|Y~0\,
	regout => dut_input(8));
...
\datau[3]\ : maxv_lcell
-- Equation(s):
-- datau(3) = DFFEAS((\shift_reg~2_combout\ & (\dut_instance|add_instance|inst6|inst9|Y~0\ $ (((\dut_instance|add_instance|inst8|inst4|Y~0\))))) # (!\shift_reg~2_combout\ & (((datau(4))))), 
...
PORT MAP (
	...
	dataa => \dut_instance|add_instance|inst6|inst9|Y~0\,
	datab => datau(4),
	datac => \dut_instance|add_instance|inst8|inst4|Y~0\,
	datad => \shift_reg~2_combout\,
	aclr => GND,
...
\datau[2]\ : maxv_lcell
-- Equation(s):
-- datau(2) = DFFEAS((\shift_reg~2_combout\ & (\dut_instance|add_instance|inst6|inst4|Y~0\ $ (((\dut_instance|add_instance|inst4|inst9|Y~0\))))) # (!\shift_reg~2_combout\ & (((datau(3))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~1_combout\, , , , )
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|inst6|inst4|Y~0\,
	datab => datau(3),
	datac => \dut_instance|add_instance|inst4|inst9|Y~0\,
	datad => \shift_reg~2_combout\,
	aclr => GND,
	ena => \datau[0]~1_combout\,
	devclrn => ww_devclrn,
...
\datau[1]\ : maxv_lcell
-- Equation(s):
-- datau(1) = DFFEAS((\shift_reg~2_combout\ & (\dut_instance|add_instance|inst2|inst9|Y~0\ $ (((\dut_instance|add_instance|inst4|inst4|Y~0\))))) # (!\shift_reg~2_combout\ & (((datau(2))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~1_combout\, , , , )
...
PORT MAP (
	...
	dataa => \dut_instance|add_instance|inst2|inst9|Y~0\,
	datab => datau(2),
	datac => \dut_instance|add_instance|inst4|inst4|Y~0\,
	datad => \shift_reg~2_combout\,
	aclr => GND,
	ena => \datau[0]~1_combout\,
	devclrn => ww_devclrn,
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|inst8|inst9|Y~0\,
	oe => VCC,
